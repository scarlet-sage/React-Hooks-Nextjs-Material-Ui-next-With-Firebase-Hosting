...
function Tooltip(props) {
  ...
  var touchTimer = _react.default.useRef(); // can be removed once we drop support for non ref forwarding class components


  var handleOwnRef = _react.default.useCallback(function (ref) {
    setChildNode(_reactDom.default.findDOMNode(ref));
  }, []);
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.cloneElement(children, (0, _extends2.default)({
    ...
    return _react.default.createElement(TransitionComponent, (0, _extends2.default)({
      ...
      className: (0, _clsx3.default)(classes.tooltip, (0, _defineProperty2.default)({}, classes.touch, ignoreNonTouchEvents.current), classes["tooltipPlacement".concat((0, _helpers.capitalize)(placementInner.split('-')[0]))])
    }, title));
  }));
}
