...
const Textarea = React.forwardRef(function Textarea(props, ref) {
  const {
    ...
    value
        ...
        other = _objectWithoutPropertiesLoose(props, ["onChange", "rowsMax", "rowsMin", "style", "value"]);
  ...
  const syncHeight = React.useCallback(() => {
    ...
    input.value = 'x';
    const singleRowHeight = input.scrollHeight; // The height of the outer content
