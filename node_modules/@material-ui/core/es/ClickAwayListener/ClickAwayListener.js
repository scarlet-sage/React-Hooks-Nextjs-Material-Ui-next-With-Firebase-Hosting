...
function ClickAwayListener(props) {
  const {
    ...
    onClickAway
        ...
        other = _objectWithoutPropertiesLoose(props, ["children", "mouseEvent", "touchEvent", "onClickAway"]);

  const mountedRef = useMountedRef();
  const movedRef = React.useRef(false);
  const nodeRef = React.useRef(); // can be removed once we drop support for non ref forwarding class components
