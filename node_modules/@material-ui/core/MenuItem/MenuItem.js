...
var MenuItem = _react.default.forwardRef(function MenuItem(props, ref) {
  ...
  return _react.default.createElement(_ListItem.default, (0, _extends2.default)({
    ...
    className: (0, _clsx2.default)(classes.root, (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.selected, selected), (0, _defineProperty2.default)(_clsx, classes.gutters, !disableGutters), _clsx), className),
    ref: ref
  }, other));
});
