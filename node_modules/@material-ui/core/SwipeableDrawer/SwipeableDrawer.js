...
function (_React$Component) {
  ...
  function SwipeableDrawer() {
    ...
    _this.handleBackdropRef = function (ref) {
      // #StrictMode ready
      _this.backdropRef = _reactDom.default.findDOMNode(ref);
    };

    _this.handlePaperRef = function (ref) {
      // #StrictMode ready
      _this.paperRef = _reactDom.default.findDOMNode(ref);
    };
  ...
  (0, _createClass2.default)(SwipeableDrawer, [{
    ...
    value: function setPosition(translate) {
      ...
      if (mode) {
        transition = this.props.theme.transitions.create('all', (0, _utils2.getTransitionProps)({
    ...
    value: function render() {
      ...
      var BackdropProps = _this$props2$ModalPro.BackdropProps,
          ...
          other = (0, _objectWithoutProperties2.default)(_this$props2, ["anchor", "disableBackdropTransition", "disableDiscovery", "disableSwipeToOpen", "hysteresis", "innerRef", "minFlingVelocity", "ModalProps", "onOpen", "open", "PaperProps", "SwipeAreaProps", "swipeAreaWidth", "variant"]);
...
var _default = (0, _withTheme.default)((0, _withForwardedRef.default)(SwipeableDrawer));
