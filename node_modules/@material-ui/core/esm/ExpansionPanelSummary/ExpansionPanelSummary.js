...
var ExpansionPanelSummary = React.forwardRef(function ExpansionPanelSummary(props, ref) {
  ...
  return React.createElement(ButtonBase, _extends({
    ...
    className: clsx(classes.root, (_clsx = {}, _defineProperty(_clsx, classes.disabled, disabled), _defineProperty(_clsx, classes.expanded, expanded), _defineProperty(_clsx, classes.focused, focusedState), _clsx), className),
