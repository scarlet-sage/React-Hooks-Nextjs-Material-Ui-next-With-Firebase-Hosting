...
var Tab = _react.default.forwardRef(function Tab(props, ref) {
  ...
  var classes = props.classes,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["classes", "className", "disabled", "fullWidth", "icon", "indicator", "label", "onChange", "onClick", "selected", "textColor", "value", "wrapped"]);
  ...
  return _react.default.createElement(_ButtonBase.default, (0, _extends3.default)({
    focusRipple: true,
    className: (0, _clsx2.default)(classes.root, classes["textColor".concat((0, _helpers.capitalize)(textColor))], (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes.disabled, disabled), (0, _defineProperty2.default)(_clsx, classes.selected, selected), (0, _defineProperty2.default)(_clsx, classes.labelIcon, label && icon), (0, _defineProperty2.default)(_clsx, classes.fullWidth, fullWidth), (0, _defineProperty2.default)(_clsx, classes.wrapped, wrapped), _clsx), className),
    ref: ref,
    role: "tab",
