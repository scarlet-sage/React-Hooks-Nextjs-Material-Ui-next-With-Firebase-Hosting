...
function (_React$Component) {
  ...
  function Slide() {
    ...
    _this.handleRef = function (ref) {
      // #StrictMode ready
      _this.childDOMNode = _reactDom.default.findDOMNode(ref);
      (0, _reactHelpers.setRef)(_this.props.children.ref, ref);
    };
    ...
    if (typeof window !== 'undefined') {
      _this.handleResize = (0, _debounce.default)(function () {
        ...
        if (_this.childDOMNode) {
          setTranslateValue(_this.props, _this.childDOMNode);
        }
  ...
  (0, _createClass2.default)(Slide, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_reactTransitionGroup.Transition, (0, _extends2.default)({
