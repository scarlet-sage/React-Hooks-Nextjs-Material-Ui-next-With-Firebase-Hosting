...
function (_React$Component) {
  ...
  function Popper(props) {
    ...
    _this.tooltipRef = _react.default.createRef();
    ...
    _this.handleOpen = function () {
      ...
      var popperNode = _this.tooltipRef.current;
      ...
      _this.popper = new _popper.default(getAnchorEl(anchorEl), popperNode, (0, _extends2.default)({
        ...
        onCreate: (0, _helpers.createChainedFunction)(_this.handlePopperUpdate, popperOptions.onCreate),
        onUpdate: (0, _helpers.createChainedFunction)(_this.handlePopperUpdate, popperOptions.onUpdate)
      }));
    };
    ...
    _this.handleRef = function (ref) {
      (0, _utils2.setRef)(_this.props.innerRef, ref);
      (0, _utils2.setRef)(_this.tooltipRef, ref);
    };
  ...
  (0, _createClass2.default)(Popper, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          other = (0, _objectWithoutProperties2.default)(_this$props2, ["anchorEl", "children", "container", "disablePortal", "innerRef", "keepMounted", "modifiers", "open", "placement", "popperOptions", "transition"]);
...
var _default = (0, _utils2.withForwardedRef)(Popper);
