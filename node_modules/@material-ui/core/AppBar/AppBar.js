...
var AppBar = _react.default.forwardRef(function AppBar(props, ref) {
  ...
  return _react.default.createElement(_Paper.default, (0, _extends2.default)({
    ...
    component: "header",
    elevation: 4,
    className: (0, _clsx2.default)(classes.root, classes["position".concat((0, _helpers.capitalize)(position))], (_clsx = {}, (0, _defineProperty2.default)(_clsx, classes["color".concat((0, _helpers.capitalize)(color))], color !== 'inherit'), (0, _defineProperty2.default)(_clsx, 'mui-fixed', position === 'fixed'), _clsx), className),
    ref: ref
  }, other));
});
