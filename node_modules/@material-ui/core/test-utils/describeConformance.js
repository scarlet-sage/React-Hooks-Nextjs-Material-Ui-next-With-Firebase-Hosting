...
function testClassName(element, getOptions) {
  it('applies the className to the root component', function () {
    ...
    var wrapper = mount(_react.default.cloneElement(element, {
      className: className
    }));
...
function testPropsSpread(element, getOptions) {
  it("does spread props to the root component", function () {
    ...
    var wrapper = mount(_react.default.cloneElement(element, (0, _defineProperty2.default)({}, testProp, value)));
...
function describeRef(element, getOptions) {
  describe('ref', function () {
    it("attaches the ref", function () {
      ...
      (0, _testRef.default)(element, mount, function (current) {
        return _chai.assert.instanceOf(current, refInstanceof);
      });
    });
  });
}
